...
<body>
    <div class="container">
        <h1>Inclusao ou Modularizacão de Recursos</h1>
        <hr>
        ...
        <h2>Exemplo de carregamento de de conteúdo parcial/fragmento</h2>
        <section>
            <h3>Título qualquer!</h3>
            <?php include "18-textos.php"; ?>
        </section>
