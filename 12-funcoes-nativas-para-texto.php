...
<body>
    <div class="container">
       ...
       <hr>
       <!-- mb -> multibyte: permite trabalhar com acentos,
       caracyteres especiais, cedilha -->
      ...
      <?php
      $frase = "Esta e uma frase com palavras feias, como burro, idiota, chato
      demais e outras palavras ruins (bobo, panaca etc)! Chato mesmo! BOBO pra
      caramba. Tambem é um BOBÃO.";
      ...
      ?>
        ...
        $textoSemEspaços = trim($textoComEspacosAdicionais);
