    ...
    <div class="container">
        ...
        <p>Extrai chaves associativas para variáveis .< /p>
                ...
                <p>Junta dados de arrays diferentes .< /p>
                        ...
                        <hr>
                        <h2>array_combine()</h2>
                        <p>Cria um novo array a partir de uma lista de valores e uma lista
                            de chaves.</p>
                        <?php
                        // Lista de chaves
                        ...
                        <h2>array_map()</h2>
                        <p>Percorre cada elemento de um array, executa uma função (chamada
                        de callback) e gera um novo array com os resultados.</p>
